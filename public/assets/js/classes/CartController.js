export default class CartController {
    ...
    functions = {
        ...
        addToCart(e) {
            ...
            const quantity      = quantityField ? quantityField.value : this.variables.cartItems += 1; // Define product quantity. Quanity from products or from inner page.
            
            this.dom.cartCount.innerText = quantity;
